    ...
    <div class="form-horizontal">
        ...
        <div class="span5">
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    echo CHtml::textField("email",
                            $email,                           
                            array('size' => 60, 'maxlength' => 300,'readonly'=>"readonly")
            ...
            <div class="control-group">
                ...
                <div class="controls">
                     <?php echo $form->textField($model, 'upload_status', array('size' => 60, 'maxlength' => 300,'readonly'=>"readonly")); ?>
...
//                    echo print_r($checkedTypes);
            ...
            <div class="control-group">
                ...
                <?php echo $form->labelEx($model, 'description', array('class' => 'control-label')); ?>
                  <a class="myHint" data-content="Please provide a full description of the dataset,
                   this may look like an abstract to a paper. Please note,
                   this text box accepts HTML code tags for formatting,
                   so you may use <br> for line breaks, <em>for italics<em/> 
                   and <b>for bold<b/>"></a>
                <div class="controls">
            ...
            <div class="control-group">
                ...
                <?php echo CHtml::label('Estimated Dataset Size','',
        ...
        <div class="span6">
            ...
            <div class="control-group">
                ...
                <a class="myHint" data-content="GigaScience database will
                   ...
                   please see here<http://creativecommons.org/about/cc0> 
