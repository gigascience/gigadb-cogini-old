    ...
    <div class="span12">
        <div class="data-img" style="float:right;width:220px;margin-left:20px;margin-bottom:20px;">
            ...
            if (isset($model->image)) {
                ...
                echo '<a href="' . $url . '">';
                echo MyHtml::image($url ? $url : $model->image->image('image_upload'), $model->image->image('image_upload'), array('class' => 'image-hint', 'title' => '<ul style="text-align:left;"><li>' . $model->image->tag . '</li><li>' . 'License: ' . $model->image->license . '</li><li>' . 'Source: ' . $model->image->source . '</li><li>' . 'Photographer: ' . $model->image->photographer . '</li></ul>'));
                echo '</a>';
            }
            else
                echo'';
