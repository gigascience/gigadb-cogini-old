...
//            $type_count=count($datasettypes_hints);
        ...
        $type_info = array();
        $temp = "All Types " . " (" . $count . ")";

        $type_info[0] = $temp;
        
        $types = Type::model()->getListTypes();
...
//        array_unshift($type_info, $temp);
    ...
    public function actionAjaxLoadDataset() {
        ...
        $this->renderPartial('slider', array('datasets' => $datasetModel, 'type'=>$type,'typeText' => $typeText));
    }
