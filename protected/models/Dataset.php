...
#            array('projectIDs , sampleIDs , authorIDs , datasetTypeIDs' , 'safe'),
	 ...
	 * @param  array $criteria        Keywords from form input
	 * @param  array $extraDatasetIds
	 * @return array
	 */
    ...
    /**
     * Get FileIds By Dataset Ids
     * @param  array  $datasetIds     
     * @param  boolean $groupByDataset
     * @return array
     */
	public static function getFileIdsByDatasetIds($datasetIds, $groupByDataset = false)
    {
		$datasetIds = implode(' , ', $datasetIds);

        // If no dataset ids we return an empty array
		if (!$datasetIds) {
            return array();
		}
