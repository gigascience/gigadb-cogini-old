...
class Attribute extends MyActiveRecord
{
    ...
    public function relations()
    {
        ...
        return array(
            'sampleAttributes' => array(self::HAS_MANY, 'SampleAttribute', 'attribute_id'),
            'fileAttributes' => array(self::HAS_MANY, 'FileAttributes', 'attribute_id'),
            'expAttributes' => array(self::HAS_MANY, 'ExpAttributes', 'attribute_id'),
            'datasetAttributes' => array(self::HAS_MANY, 'DatasetAttributes', 'attribute_id'),
        );
    }
